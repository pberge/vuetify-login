  ...
  >
    <v-toolbar>
      ...
      <v-text-field
        ...
        solo
      >
        <v-btn text small><v-icon right>fa-search</v-icon></v-btn>
      </v-text-field>
    </v-toolbar>
  ...
  export default {
    data: () => ({
      ...
      items: [
        ...
        { icon: 'fa-boxes', text: 'PRODUCTS', link: '', numCols: 3, contCol: [5, 4, 3], 
                                                  values: [ { 
                                                              title: 'SDDC Platform', 
    ...
    methods: {
      ...
      show (item) {
        if (item.text === this.itemSelected.text) this.itemSelected = ''
